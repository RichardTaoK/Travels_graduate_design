...
<html>
<head>
    <title>联系我们-摄途网-专业摄影旅游网站</title>
    <meta name="renderer" content="webkit">
    <meta charset="utf-8"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta name="generator" content="MetInfo 5.3.19" data-variable="https://www.shotour.com/,cn,121,121,1,M1089008"/>
    <meta name="description" content="韩孟涛"/>
    <meta name="keywords" content="摄影旅游,黄山摄影团"/>
...
<div class="met-banner-econy">
    <img src="/statics/images/travel/about1.jpg">
    <div class="econynr">
        <div class="container">
            <div class="row">
            ...
            <div class="col-md-12 sidebar_tile">
                <div class="row">
                    ...
                    <ul class="met-column-nav-ul">
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=7c88aaed8adc8f9c5c4db9607c98e933&sql=select+%2A+from+travel_category+where+parentid%3D18+order+by+catid+asc&return=data\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("select * from travel_category where parentid=18 order by catid asc LIMIT 20");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);?>
                        <?php $n=1; if(is_array($data)) foreach($data AS $k => $r) { ?>
                        <li class="dropdown">
                            <a href="<?php echo $r['url'];?>" class="link"><?php echo $r['catname'];?></a>
                        </li>
                        <?php $n++;}unset($n); ?>
                        <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                    </ul>
