...
<html>
<head>
    <title>黄山摄影团-摄影线路-摄途网-专业摄影旅游网站</title>
    <meta name="renderer" content="webkit">
    <meta charset="utf-8"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta name="generator" content="MetInfo 5.3.19" data-variable="https://www.shotour.com/,cn,104,,3,M1089008"/>
...
<div class="met-banner-econy">
    <img src="/statics/images/travel/2/banner.jpg">
    <div class="econynr">
        <div class="container">
            <div class="row">
                ...
                <div class="breadcumb col-sm-6 pull-right">
                    ...
                    <a href="<?php echo siteurl($siteid);?>">首页</a><span> > </span><?php echo catpos($catid);?>
                </div>
            </div>
        </div>
    </div>
...
<div class="met-column-nav product-search-body bordernone" style="margin-top: 10px">
    <div class="container">
        <div class="row">
            <div class="col-md-9 sidebar_tile">
                <div class="row">
                    <ul class="met-column-nav-ul">
                        <!--<li><a href="../line/" class="link" target='_blank' title=""></a></li>-->
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=bee95c21616a6d367bf4a11490a976b3&sql=select+%2A+from+travel_category+where+parentid%3D10+order+by+catid+asc&return=data\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("select * from travel_category where parentid=10 order by catid asc LIMIT 20");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);?>
                        <?php $n=1; if(is_array($data)) foreach($data AS $key => $val) { ?>
                        <li class="dropdown">
                            <a class="link" <?php if($val['catname']==$catid) { ?>class="active"<?php } ?> href="<?php echo $val['url'];?>"
                            ><?php echo $val['catname'];?></a>
                        </li>
                        <?php $n++;}unset($n); ?>
                        <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                    </ul>
            ...
            <div class="col-md-3 product_search ">
                <div class="row">
                    <form method="get" action="https://www.shotour.com/line/">
                        ...
                        <div class="form-group">
                            <div class="input-search">
                                ...
                                <input type="text" class="form-control" name="content" value="" placeholder="">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="less-page-content">
                    ...
                    <li class="masonry-item ">
                        <div class="widget widget-shadow">
                            ...
                            <h4 class="widget-title">
                                <a href="showproduct.php?lang=cn&id=32" title="<?php echo $r['title'];?>"
                                   target='_blank'><?php echo $r['title'];?></a>
                                <p class='margin-bottom-0 margin-top-5 red-600'><?php echo $r['num'];?>元</p>
                            </h4>
                        </div>
                    </li>
                    <?php $n++;}unset($n); ?>
                ...
                <div class="hidden-xs">
                    <div class='met_pager'>
                        <span class='PreSpan'>上一页</span><a href=product.php?lang=cn&class1=103&class2=104
                                                           class='Ahover'>1</a><span class='NextSpan'>下一页</span>
                        <span class='PageText'>转至第</span>
                        <input type='text' id='metPageT'
                               data-pageurl='product.php?lang=cn&class1=103&class2=104&page=||1' value='1'/>
                ...
                <div class="met-page-ajax-body visible-xs-block invisible" data-plugin="appear"
                    ...
                    <button type="button" class="btn btn-default btn-block btn-squared ladda-button" id="met-page-btn"
                            ...
                            data-url="https://www.shotour.com/line/product.php?lang=cn&class1=103&class2=104&class3=0&mbpagelist=1"
