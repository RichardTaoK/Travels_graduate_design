...
<html>
<head>
    <title>2018年4月黄山摄影作品（多图）-摄途网-专业摄影旅游网站</title>
    <meta name="renderer" content="webkit">
    <meta charset="utf-8"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta name="generator" content="MetInfo 5.3.19" data-variable="https://www.shotour.com/,cn,110,228,5,M1089008"/>
    <meta name="description"
          content="四月黄山的春景，犹如浓烈的美酒，醇美芬芳。黄山，她可以骄傲的独享上天的厚爱，将阳光雨露的滋养与日月精华的润泽变成自己的盛世美颜。四月芳菲尽，黄山仲春时，你就是最美的人间四月天。四月的黄山，晴日和雨水总是泾渭分明，日出日落的壮观和烟雨缥缈的柔媚一样明艳动人。层峦叠嶂的群山在自然与岁月的雕琢下展现出奇特的模样，近处的怪石在云海薄雾中时隐时现，巍峨的远山却一望无垠，水墨意境下的黄山妙不可言。四月的黄山，"/>
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="example-navbar-default-collapse">
                ...
                <ul class="nav navbar-nav navbar-right navlist">
                    ...
                    <li class="dropdown margin-left- ecodropdown">
                        <a class="dropdown-toggle link " data-toggle="dropdown" href="road/" aria-expanded="false"
                ...
                <div class="row">
                    <div class="met-shownews-header">
                        ...
                        <div class="info">
                            ...
                            <span><i class="icon wb-eye margin-right-5" aria-hidden="true"></i>266</span>
                        </div>
                    </div>
                    <div class="met-editor lazyload clearfix">
                        <!--<p class='text-center'>-->
                            <!--<img data-original="../upload/201804/watermark/1524058736.jpg" alt='2018年4月黄山摄影作品（多图）'/>-->
                        <!--</p>-->
                        <p ><?php echo $title;?></p>
                        <div><p style="text-align: center;"><?php echo $content;?></p></div>
                    ...
                    <div class="met-shownews-footer">
                        <ul class="pager pager-round">
                            <li class="previous ">
                                <a href="<?php echo $previous_page['url'];?>" title="<?php echo $previous_page['title'];?>">
                                    <span aria-hidden="true" class='hidden-xs hidden-sm'>上一篇：<?php echo $previous_page['title'];?></span>
                                </a>
                            </li>
                            <li class="next disabled">
                                <a href="<?php echo $next_page['url'];?>" title="<?php echo $next_page['title'];?>">
                                    <span aria-hidden="true" class='hidden-xs hidden-sm'>下一篇：<?php echo $next_page['title'];?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="met-news-bar">
                        ...
                        <div class="recommend news-list-md">
                            ...
                            <ul class="list-group list-group-bordered">
                                ...
                                <li class="list-group-item">
                                    <a href="<?php echo $r['url'];?>" title="<?php echo $r['title'];?>" target='_blank'><?php echo str_cut($r[description], 28, '');?></a>
                                </li>
                                <?php $n++;}unset($n); ?>
                                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                            </ul>
                        ...
                        <ul class="column">
                            <li><a href="../photographic/" title="所有文章" target='_blank'>所有文章</a></li>
                            ...
                            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                            <li>
                                <a href="<?php echo $r['url'];?>" <?php echo title_style($r[style]);?> class="title" title="<?php echo $r['title'];?>"><?php echo str_cut($r[description],56,'...');?></a>
                            </li>
                            <?php $n++;}unset($n); ?>
                            <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
