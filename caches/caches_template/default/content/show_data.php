                ...
                <div class="row">
                    <div class="met-news-bar">
                        ...
                        <div class="recommend news-list-md">
                            ...
                            <ul class="list-group digg">
                                <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                                <li class="">
                                    <a href="<?php echo $r['url'];?>" <?php echo title_style($r[style]);?> title="<?php echo $r['title'];?>" target='_blank'><?php echo str_cut($r[title],56,'...');?></a>
                                </li>
                                <?php $n++;}unset($n); ?>
                            </ul>
                            <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                        </div>
                        <h3 style="font-weight: 300;font-size: 18px">所有文章</h3>
