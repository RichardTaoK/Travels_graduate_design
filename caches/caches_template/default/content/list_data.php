                                ...
                                <div class="media media-lg">
                                    <div class="media-left">
                                        <a href="<?php echo $r['url'];?>" title="<?php echo $r['title'];?>" target='_blank'>
                                            <img class="media-object" src="<?php echo $r['thumb'];?>" height='400' alt="<?php echo $r['title'];?>">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        ...
                                        <p class="des"><?php echo $r['description'];?></p>
                                        <p class="info">
                                            <span><?php echo $r['inputtime'];?></span>
                                            <span class="margin-left-10"><?php echo $r['author'];?></span>
                                            <span class="margin-left-10"><i class="icon wb-eye margin-right-5"
                                                                            aria-hidden="true"></i>634</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="met-news-bar">
                        ...
                        <script>
                            $(function(){
                                $('.rank li a').on('mouseover',function () {
